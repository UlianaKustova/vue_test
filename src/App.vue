  ...
  <v-app>
        ...
        <svg viewBox="0 0 300 300" aria-hidden="true">
            <g>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath">оаоа1</textPath>
                </text>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath" startOffset="50%">оаоа2</textPath>
                </text>
            </g>
        </svg>
    </a>
    <a href="#link">
        ...
        <svg viewBox="0 0 300 300" aria-hidden="true">
            <g>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath">помогут</textPath>
                </text>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath" startOffset="50%">Услуги вам не </textPath>
                </text>
            </g>
        </svg>
    </a>
    <a href="#link">
        ...
        <svg viewBox="0 0 300 300" aria-hidden="true">
            <g>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath">О вас</textPath>
                </text>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath" startOffset="50%">не о нас</textPath>
                </text>
            </g>
        </svg>
    </a>
    <a href="#link">
        ...
        <svg viewBox="0 0 300 300" aria-hidden="true">
            <g>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath">шоу</textPath>
                </text>
                <text fill="currentColor">
                    <textPath xlink:href="#circlePath" startOffset="50%">Контакты с</textPath>
                </text>
            </g>
        </svg>
    </a>
